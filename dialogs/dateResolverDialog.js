...
class DateResolverDialog extends CancelAndHelpDialog {
    ...
    async initialStep(stepContext) {
        ...
        const promptMessageText = 'On what date would you like your order delivered?';
        const promptMessage = MessageFactory.text(promptMessageText, promptMessageText, InputHints.ExpectingInput);

        const repromptMessageText = "I'm sorry, for best results, please enter the delivery date including the month, day and year.";
